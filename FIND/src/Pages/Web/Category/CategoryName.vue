...
const fetchSubcategories = async () => {
    try {
        if (name.value) {
            const response = await axiosClient.get(`/subcategoriesByname/${name.value}`);
                         ...
                         <div class="relative col-span-3 p-2">
                                ...
                                <div :class="showFiltre ? 'fixed inset-0   top-0  bottom-0  dark:bg-gray-800 bg-white z-50 p-4 transition-all duration-200 w-full' : 'hidden w-full mt-0   z-20'"
                                    ...
                                    <div class="flex flex-col p-2">
                                        ...
                                        <div v-if="isLoadingSubcategorie" class="flex flex-wrap gap-2 lg:grid lg:grid-cols-1">
                                ...
                                <div class="flex flex-wrap gap-4">
                                    ...
                                    <div v-for="category in categories">
                                        <router-link :to="{ name: 'Category.name', params: { name: category.name } }"
                                            ...
                                            <div
                                                class="absolute inline-flex items-center justify-center p-2 w-4 h-4 text-[10px] font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -right-2 dark:border-gray-900">
                                                23</div>
                                        </router-link>
                                    </div>
