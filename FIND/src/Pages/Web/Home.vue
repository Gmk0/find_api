    ...
    <div class="relative min-h-screen slideshow slideshow-wrapper pb-section sliderFull">
        ...
        <div class="absolute top-0 left-0 w-full h-screen bg-skin-fill dark:bg-gray-800 lg:hidden">
            ...
            <div class="relative w-full lg:-mt-10" id="girl">
                ...
                <!-- calendar -->
                <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="absolute top-20 left-6 floating-4">
                    <img class="h-12 bg-white rounded-lg bg-opacity-80 sm:h-16" src="/canva/feedback.png">
                </div>
                <!-- red -->
                <div data-aos="fade-up" data-aos-delay="400" data-aos-once="true" class="absolute right-24 top-28 floating">
    ...
    <div id="talkAbout" class="bg-white dark:bg-gray-800 lg:min-h-screen">
        ...
        <div class="container max-w-6xl p-4 m-4 mx-auto md:p-6">
            ...
            <div>
                ...
                <swiper class="flex py-8" :modules="[Navigation, Pagination, Scrollbar, EffectCube, A11y]" effect="cube"
                    :spaceBetween="30" :slides-per-view="1" :space-between="25" :pagination="{ clickable: true }">
                            ...
                            <div>
                                <div v-for="(faq, index) in faqs" :key="faq.question">
                                    <button
                                        ...
                                        <svg v-show="!faq.isOpen" class="fill-current" viewBox="0 0 24 24" width="24"
                                            height="24">
